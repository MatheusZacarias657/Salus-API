package api.src.salus.api.Application.Adapter;

import api.src.salus.api.Domain.Adapter.EmailBrevoPayload;
import api.src.salus.api.Domain.Adapter.EmailContact;
import api.src.salus.api.Domain.Interface.Application.Adapter.IBrevoSendEmail;
import api.src.salus.api.Domain.Interface.Application.HttpFactory.IHttpFactory;
