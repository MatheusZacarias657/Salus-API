package api.src.salus.api.Application.Service.FAQ;

import api.src.salus.api.Domain.DTO.FAQ.DetailingFaqDTO;
...
import api.src.salus.api.Repository.FAQ.IFAQRepositoryJPA;
import api.src.salus.api.Repository.FAQ.IGroupFAQRepositoryJPA;
